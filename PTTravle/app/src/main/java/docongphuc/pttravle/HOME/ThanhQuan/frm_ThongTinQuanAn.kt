 ...
 */
class frm_ThongTinQuanAn: Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        listQuanAn.add(ThongTinQuanAN_DL("https://www.scandichotels.com/imagevault/publishedmedia/qn6infvg30381stkubky/scandic-sundsvall-city-restaurant-verket-10.jpg","quan an Chu j","123/123/an dương vương",listanhquanan,11,123,3.5f))
