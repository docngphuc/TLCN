...
class Lich_adapter(var context : Context, var mang : ArrayList<LichTrinh_data_day>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertview: View?, parent: ViewGroup?): View {
        ...
        val lich : LichTrinh_data_day = getItem(position) as LichTrinh_data_day
